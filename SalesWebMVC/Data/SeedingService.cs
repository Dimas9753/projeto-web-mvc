...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 5), 1000.00, d1);
            Seller s2 = new Seller(2, "Cris Nogueira", "cris@yahoo.com", new DateTime(1960, 3, 29), 1100.00, d2);
            Seller s3 = new Seller(3, "Cicero Silva", "cicero@outlook.com", new DateTime(1989, 7, 12), 1200.00, d3);
            Seller s4 = new Seller(4, "Josi Santos", "josi@gmail.com", new DateTime(2000, 9, 6), 1300.00, d1);
            Seller s5 = new Seller(5, "Danilo Barbosa", "danilo@gmail.com", new DateTime(1996, 11, 24), 1400.00, d2);
            Seller s6 = new Seller(6, "Dimas Diogenes", "dimas@hotmail.com", new DateTime(1991, 1, 17), 1500.00, d3);
